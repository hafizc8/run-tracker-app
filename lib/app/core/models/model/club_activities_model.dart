...
class ClubActivitiesModel extends Equatable {
  ...
  factory ClubActivitiesModel.fromJson(Map<String, dynamic> json) {
    return ClubActivitiesModel(
      ...
      challange: json["challange"] == null
          ? null
          : Challange.fromJson(json["challange"]),
...
class Challange extends Equatable {
  ...
  factory Challange.fromChallengeModel(ChallengeModel challengeModel) {
    return Challange(
      id: challengeModel.id,
      type: challengeModel.type,
      typeText: challengeModel.typeText,
      title: challengeModel.title,
      mode: challengeModel.mode,
      modeText: challengeModel.modeText,
      startDate: challengeModel.startDate,
      endDate: challengeModel.endDate,
      clubId: challengeModel.clubId,
      target: challengeModel.target,
      teamSize: challengeModel.teamSize,
      challangeUsersCount: challengeModel.challangeUsersCount,
      cancelledAt: challengeModel.cancelledAt,
      createdAt: challengeModel.createdAt,
      isJoined: challengeModel.isJoined,
      isOwner: challengeModel.isOwner,
      isPendingJoin: challengeModel.isPendingJoin,
      teams: challengeModel.teams,
      userProgress: 0,
      teamProgress: 0,
    );
  }
