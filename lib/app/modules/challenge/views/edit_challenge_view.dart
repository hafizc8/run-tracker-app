...
class ChallengeEditView extends GetView<ChallangeEditController> {
          ...
          if (controller.form.value.type == 0) {
            return SizedBox(
              ...
              child: GradientElevatedButton(
                ...
                onPressed: controller.isLoading.value || !controller.isEdited
                    ? null
                    : () {
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: controller.form.value.type == 0
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: controller.form.value.type == 0
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        padding: EdgeInsets.all(1.w), // Lebar border
                        decoration: BoxDecoration(
                          gradient: controller.form.value.type == 1
                              ? const LinearGradient(
                                  colors: [
                                    Color(0xFFA2FF00),
                                    Color(0xFF00FF7F),
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: controller.form.value.type == 1
                                ? Theme.of(context).colorScheme.background
                                : const Color(0xFF5E5E5E),
                            borderRadius: BorderRadius.circular(10.r),
                          ),
              ...
              Container(
                padding: EdgeInsets.all(1.w), // Lebar border
                decoration: BoxDecoration(
                  gradient: controller.form.value.mode == 0
                      ? const LinearGradient(
                          colors: [
                            Color(0xFFA2FF00),
                            Color(0xFF00FF7F),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => Visibility(
                                    visible: controller.form.value.mode == 0,
                                    child: Column(
                                      crossAxisAlignment:
              ...
              Container(
                padding: EdgeInsets.all(1.w), // Lebar border
                decoration: BoxDecoration(
                  gradient: controller.form.value.mode == 1
                      ? const LinearGradient(
                          colors: [
                            Color(0xFFA2FF00),
                            Color(0xFF00FF7F),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => Visibility(
                                    visible: controller.form.value.mode == 1,
                                    child: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      mainAxisSize: MainAxisSize.min,
