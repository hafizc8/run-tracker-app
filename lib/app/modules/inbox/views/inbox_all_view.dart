...
class InboxAllView extends GetView<InboxAllController> {
  const InboxAllView({super.key});
    ...
    return Obx(() {
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          if (chat.relateableUser != null) {
            return InkWell(
              onTap: () => controller.goToRoomChatFriend(chat),
              child: Row(
                children: [
                  _buildAvatar(
                    context,
                    chat.relateableUser?.imageUrl,
                    chat.relateableUser?.name,
                  ),
          ...
          if (chat.relateableEvent != null) {
            return InkWell(
              onTap: () => controller.goToRoomChatEvent(chat),
              child: Row(
                children: [
                  _buildAvatar(
                    context,
                    chat.relateableEvent?.imageUrl,
                    chat.relateableEvent?.title,
                    isShowIcon: true,
                    isEvent: true,
                  ),
                  const SizedBox(width: 24),
