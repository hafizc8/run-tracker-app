...
class ShareClubController extends GetxController {
  final ClubModel clubModel;

  ShareClubController({required this.clubModel});

  Rx<ClubModel?> clubData = Rx<ClubModel?>(null);
  ...
  Future<void> shareTo(String platform) async {
    ...
    String message = AppConstants.shareClubLink(clubModel.id!);
