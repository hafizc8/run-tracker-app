...
class ShareClubCard extends StatelessWidget {
  const ShareClubCard({super.key, required this.clubModel});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${clubModel.province ?? ''}, ${clubModel.country ?? ''}',
                    ...
                    Row(
                      ...
                      children: [
                        _buildPlaceholder(context: context, title: 'Member', subtitle: NumberHelper().formatNumberToKWithComma(clubModel.clubUsersCount ?? 0)),
                        _buildPlaceholder(context: context, title: 'Events', subtitle: NumberHelper().formatNumberToKWithComma(clubModel.eventsCount ?? 0)),
                      ],
                    ),
                  ],
                ),
